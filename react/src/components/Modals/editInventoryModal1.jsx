        ...
        <div className="modal1">
            <div className="modal-box3">
                ...
                {editMedicine.hasMeasurement && (
                    <>
                        <label htmlFor="measurementUnit" style={{marginTop: "30px"}}>Measurement Unit</label>
                        <Select
                        style={{width: "100%"}}
                        size="large"
                        ...
                        <label htmlFor="measurementVal" style={{marginTop: "30px"}}>Measurement Value</label>
                        <input type="number" name="measurementVal" id="measurementVal" value={editMedicine.measurementVal} onChange={handleInputChange} />
                    </>
                )}
                ...
                <button className="primary-btn-blue1" style={{marginTop: "30px"}} onClick={() => {handleEditMedPost(editMedicine); onClose();}}>Add</button>
            </div>
        </div>
    )
}