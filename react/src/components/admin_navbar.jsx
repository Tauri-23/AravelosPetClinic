    ...
    return(
        <div className="nav nav1">
            ...
            <div className="nav1-links">
                ...
                <Link to={'/AdminIndex/ManageProfiles'} className="nav2-link"><div className="wx"><img src="/assets/media/icons/user.svg" className="nav1-icons" alt="logo"/></div><div className="nav1-link"><p>Manage Accounts</p><div className={`nav1-line${location.pathname === "/" ? " active" : ""}`} ></div></div></Link>
                <Link to={'/AdminIndex/AdminFeedbackAnalysis'} className="nav2-link"><div className="wx"><img src="/assets/media/icons/feedback.svg" className="nav1-icons" alt="logo"/></div><div className="nav1-link"><p>Feedback Analysis</p><div className={`nav1-line${location.pathname === "/" ? " active" : ""}`} ></div></div></Link>
