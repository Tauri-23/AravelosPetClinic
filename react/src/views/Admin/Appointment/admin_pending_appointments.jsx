...
import { formatDate, isEmptyOrSpaces } from "../../../assets/js/utils";
...
export default function AdminPendingAppointments() {
    ...
    useEffect(() => {
        const getAll = async() => {
            const data = await fetchAllAppointmentsWhereStatus("Pending");
        ...
        <>
            ...
            <div className="myappt small-form">
                ...
                {appointments?.length > 0 && appointments.map(appointment => (
                        <div key={appointment.id} className='appt-record-three pending' onClick={() => handleAppointmentRecordClick(appointment)}>
